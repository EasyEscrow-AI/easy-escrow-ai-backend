...
const clientAccounts: Record<string, AccountDef[]> = {
  'ops@helvetica-digital.ch': [
    {
      name: 'Treasury',
      label: 'Main Treasury Vault',
      accountType: 'TREASURY',
      description: 'Primary treasury account for institutional custody reserves',
    ...
    },
    {
      ...
      description: 'Day-to-day operational account for client settlements',
    ...
    },
    {
      ...
      description: 'Dedicated settlement account for cross-border USDC transfers',
