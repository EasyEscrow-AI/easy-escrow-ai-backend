 ...
 * 
 * SECURITY: Requires API key authentication to prevent unauthorized program usage
 * Only authorized clients (our frontend apps) can create offers
 */
router.post(
  '/api/offers',
  requireApiKey, // CRITICAL: Only authorized clients can create offers
  strictRateLimiter,
